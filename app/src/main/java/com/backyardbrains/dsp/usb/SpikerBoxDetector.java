    ...
    void startDetection(@NonNull UsbDevice device) {
        if (manager != null) {
            ...
            if (usbDevice != null) {
                ...
                FirebaseCrashlytics.getInstance().recordException(new RuntimeException("Failed to connect to USB device!"));
            }
        } else {
            if (listener != null) {
            ...
            FirebaseCrashlytics.getInstance().recordException(new RuntimeException("Connected USB device is not supported!"));
        }
    }
