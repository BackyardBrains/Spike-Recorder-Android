...
public class BybEmptyView extends FrameLayout {
    ...
    public BybEmptyView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BybEmptyView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init();
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public BybEmptyView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
