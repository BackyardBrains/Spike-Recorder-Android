...
public class FindSpikesRenderer extends BYBBaseRenderer {
    ...
    @Override protected void drawingHandler(GL10 gl) {
        ...
        float[] thresholdLine = new float[] {
            -thresholdLineLength * 2, thresholds[LEFT_THRESH_INDEX], thresholdLineLength * 2,
            thresholds[LEFT_THRESH_INDEX], -thresholdLineLength * 2, thresholds[RIGHT_THRESH_INDEX],
            thresholdLineLength * 2, thresholds[RIGHT_THRESH_INDEX]
        };
