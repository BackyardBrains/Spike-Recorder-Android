...
public class BYBFindSpikesAnalysis extends BYBBaseAsyncAnalysis {
	...
	public void process(short[] data){
	    ...
	    for(ibin=0;ibin<numberOfBins;ibin++){
	        //[fileReader retrieveFreshAudio:tempCalculationBuffer numFrames:(UInt32)(lengthOfBin) numChannels:aFile.numChannels];
...
//	        numberOfFramesRead = ibin == (numberOfBins-1) ? (numberOfSamples % lengthOfBin):lengthOfBin;
	      ...
	      //  [fileReader retrieveFreshAudio:tempCalculationBuffer numFrames:(UInt32)(numberOfFramesRead) numChannels:aFile.numChannels seek:ibin*lengthOfBin];
